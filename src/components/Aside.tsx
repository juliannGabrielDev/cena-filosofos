		...
		>
			...
			<div className="mb-6 text-white">
				...
				<div className="flex flex-col gap-2">
					{!isRunning ? (
						<Button onClick={onStart} className='w-full mb-2'>Iniciar Simulación</Button>
					) : (
						<Button onClick={onStop} className='w-full bg-red-950 mb-2'>Detener Simulación</Button>
					)}
					<Button onClick={onReset} className='w-full'>Reiniciar</Button>
				</div>
			</div>
			...
			<div className="rounded-t-2xl">
				...
				{openSection === 0 && (
					<div className="p-4 bg-white">
						<p>
							El problema de la cena de los filósofos fue
							planteado por Edsger Dijkstra en 1965 como una
							metáfora para ilustrar los desafíos de la
							sincronización de procesos y la evitación de
			...
			<div className="rounded-b-2xl">
				<button
					className={`w-full text-left px-4 py-2 font-semibold bg-white hover:bg-blue-50 focus:outline-none ${openSection === 1 ? 'rounded-0' : 'rounded-b-2xl'}`}
				...
				{openSection === 1 && (
					<div className="p-4 bg-white">
						<ol className="list-decimal list-inside">
							<li>
								Un filósofo solo puede comer si tiene ambas
								cucharas (la de la izquierda y la de la
								derecha).
							</li>
							<li>
							...
							<li>
								Después de comer, un filósofo debe dejar ambas
								cucharas en la mesa.
							</li>
							<li>
